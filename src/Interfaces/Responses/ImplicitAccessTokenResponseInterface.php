...
use TrayDigita\OAuth2\Interfaces\Parameters\RefreshTokenParameterMustVoidInterface;
 ...
 * @note
 *   <strong>
 *       The authorization server MUST NOT issue a refresh token, when client sending using implicit grant
 * </strong>
 */
interface ImplicitAccessTokenResponseInterface extends
    TokenInterface,
    ExpiresInParameterInterface,
    RefreshTokenParameterMustVoidInterface,
    JsonSerializable
{
    /**
     * @inheritdoc
     * The refresh token must be not return anything
     *
     * @return void
     */
     ...
     *     "expires_in"?: int, // recommended depending lifetime
